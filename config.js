...
global.email = "pikachu1432099@gmail.com";
global.location = "Assam, India";
global.mongodb = process.env.MONGODB_URI || "";
global.allowJids = process.env.ALLOW_JID || "null";
global.blockJids = process.env.BLOCK_JID || "null";
global.DATABASE_URL = process.env.DATABASE_URL || "";
global.timezone = process.env.TZ || process.env.TIME_ZONE || "India/Assam";
global.github = process.env.GITHUB || "https://github.com/STAR-KING0/Queen_Alya";
global.gurl = process.env.GURL || "https://whatsapp.com/channel/0029VauhtxdJUM2jS9Upme02";
global.website = process.env.GURL || "https://chat.whatsapp.com/Bh0We07lYgGArH3tiAJjk6?mode=ac_c";
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "./lib/alya.jpg";
global.devs = "85259039024";
global.sudo = process.env.SUDO || "918134015876";
global.owner = process.env.OWNER_NUMBER || "85259039024";
...
module.exports = {
  ...
  author: process.env.PACK_AUTHER || "°𝓡𝓲𝓸(リオ)™모°
    𓆩ꨄ︎°𝐄𝐥𝐢𝐭𝐞 𝐀𝐥𝐥𝐢𝐚𝐧𝐜𝐞°ꨄ︎𓆪
⏤͟͞  ⃟💎안녕하 𓆩ꨄ︎𓆪 세요⃟❄️
...
🐾: ̗̀➛+⁹¹⁸¹³⁴⁰¹⁵⁸⁷⁶💌|♚ɖɛɱơŋʂ♤",
  ...
  ownername: process.env.OWNER_NAME || "Rio",
  ...
  antilink_values: process.env.ANTILINK_VALUES || "WhatsApp",
